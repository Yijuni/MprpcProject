...
class GetFrindListsRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFrindListsRequest> _instance;
} _GetFrindListsRequest_default_instance_;
class GetFrindListsResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFrindListsResponse> _instance;
} _GetFrindListsResponse_default_instance_;
}  // namespace fixbug
static void InitDefaultsscc_info_GetFrindListsRequest_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFrindListsRequest_default_instance_;
    new (ptr) ::fixbug::GetFrindListsRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFrindListsRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFrindListsRequest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFrindListsRequest_test_2eproto}, {}};

static void InitDefaultsscc_info_GetFrindListsResponse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFrindListsResponse_default_instance_;
    new (ptr) ::fixbug::GetFrindListsResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFrindListsResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFrindListsResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFrindListsResponse_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFrindListsRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFrindListsRequest, userid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFrindListsResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFrindListsResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFrindListsResponse, friend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 31, -1, sizeof(::fixbug::User)},
  { 39, -1, sizeof(::fixbug::GetFrindListsRequest)},
  { 45, -1, sizeof(::fixbug::GetFrindListsResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFrindListsRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFrindListsResponse_default_instance_),
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\006fixbug\"1\n\nResultCode\022\021\n\ter"
  "rorcode\030\001 \001(\005\022\020\n\010errormsg\030\002 \001(\014\"\204\001\n\014Logi"
  ...
  "\n\005WOMAN\020\001\"&\n\024GetFrindListsRequest\022\016\n\006use"
  "rid\030\001 \001(\r\"^\n\025GetFrindListsResponse\022\"\n\006re"
  ...
  "ixbug.GetFrindListsRequest\032\035.fixbug.GetF"
  "rindListsResponseB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[7] = {
  &scc_info_GetFrindListsRequest_test_2eproto.base,
  &scc_info_GetFrindListsResponse_test_2eproto.base,
...
void GetFrindListsRequest::InitAsDefaultInstance() {
}
class GetFrindListsRequest::_Internal {
 public:
};

GetFrindListsRequest::GetFrindListsRequest()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFrindListsRequest)
}
GetFrindListsRequest::GetFrindListsRequest(const GetFrindListsRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  userid_ = from.userid_;
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFrindListsRequest)
}

void GetFrindListsRequest::SharedCtor() {
  userid_ = 0u;
}

GetFrindListsRequest::~GetFrindListsRequest() {
  // @@protoc_insertion_point(destructor:fixbug.GetFrindListsRequest)
  SharedDtor();
}

void GetFrindListsRequest::SharedDtor() {
}

void GetFrindListsRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFrindListsRequest& GetFrindListsRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFrindListsRequest_test_2eproto.base);
  return *internal_default_instance();
}


void GetFrindListsRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFrindListsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFrindListsRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFrindListsRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFrindListsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFrindListsRequest)
  return target;
}

size_t GetFrindListsRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFrindListsRequest)
  size_t total_size = 0;
...
void GetFrindListsRequest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFrindListsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFrindListsRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFrindListsRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFrindListsRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFrindListsRequest)
    MergeFrom(*source);
  }
}

void GetFrindListsRequest::MergeFrom(const GetFrindListsRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFrindListsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFrindListsRequest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFrindListsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFrindListsRequest::CopyFrom(const GetFrindListsRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFrindListsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFrindListsRequest::IsInitialized() const {
  return true;
}

void GetFrindListsRequest::InternalSwap(GetFrindListsRequest* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(userid_, other->userid_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetFrindListsRequest::GetMetadata() const {
  return GetMetadataStatic();
}
...
void GetFrindListsResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFrindListsResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFrindListsResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFrindListsResponse* msg);
};

const ::fixbug::ResultCode&
GetFrindListsResponse::_Internal::result(const GetFrindListsResponse* msg) {
  return *msg->result_;
}
GetFrindListsResponse::GetFrindListsResponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFrindListsResponse)
}
GetFrindListsResponse::GetFrindListsResponse(const GetFrindListsResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFrindListsResponse)
}

void GetFrindListsResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFrindListsResponse_test_2eproto.base);
  result_ = nullptr;
}

GetFrindListsResponse::~GetFrindListsResponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFrindListsResponse)
  SharedDtor();
}

void GetFrindListsResponse::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFrindListsResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFrindListsResponse& GetFrindListsResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFrindListsResponse_test_2eproto.base);
  return *internal_default_instance();
}


void GetFrindListsResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFrindListsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFrindListsResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFrindListsResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFrindListsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFrindListsResponse)
  return target;
}

size_t GetFrindListsResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFrindListsResponse)
  size_t total_size = 0;
...
void GetFrindListsResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFrindListsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFrindListsResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFrindListsResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFrindListsResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFrindListsResponse)
    MergeFrom(*source);
  }
}

void GetFrindListsResponse::MergeFrom(const GetFrindListsResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFrindListsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFrindListsResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFrindListsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFrindListsResponse::CopyFrom(const GetFrindListsResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFrindListsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFrindListsResponse::IsInitialized() const {
  return true;
}

void GetFrindListsResponse::InternalSwap(GetFrindListsResponse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFrindListsResponse::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRPC::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFrindListsRequest*,
                         ::fixbug::GetFrindListsResponse*,
                         ::google::protobuf::Closure* done) {
  ...
  switch(method->index()) {
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFrindListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFrindListsResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRPC::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFrindListsRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRPC::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFrindListsResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRPC_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              const ::fixbug::GetFrindListsRequest* request,
                              ::fixbug::GetFrindListsResponse* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFrindListsRequest* Arena::CreateMaybeMessage< ::fixbug::GetFrindListsRequest >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFrindListsRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::fixbug::GetFrindListsResponse* Arena::CreateMaybeMessage< ::fixbug::GetFrindListsResponse >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFrindListsResponse >(arena);
}
